...
<head>
    ...
    <link rel="preload" href="app/assets/img/team/tinified/Gowsi.jpg" as="image">
    <link rel="preload" href="app/assets/img/team/tinified/Hesh.jpg" as="image">
...
<body id="body" class="body gradient-background">
    ...
    <div id="lowerlay-left" class="line__context line__context--center">
        <p class="text__left text__left--left text__left--left--team">Meet the team of elitesnaps</p>
                    ...
                    <div class="team-row">
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/tinified/Gowsi.jpg" src="app/assets/img/team/tinified/Gowsi.jpg" alt="Gowsi Photo">
                            </div>
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/Vishna.jpeg" src="app/assets/img/team/Vishna.jpeg" alt="Vishna Photo">
                            </div>

                            <div class="team-info">
                                <p>Vishna</p>
                                <span>CFO / Cinematographer</span>
                            </div>
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/tinified/Hesh.jpg" src="app/assets/img/team/tinified/Hesh.jpg" alt="Hesh Photo">
                            </div>

                            <div class="team-info">
                                <p>Hesh</p>
                                <span>Production Manager / Cinematographer</span>
                            </div>
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/tinified/Karun.jpg" src="app/assets/img/team/tinified/Karun.jpg" alt="Karun Photo">
                            </div>

                            <div class="team-info">
                                <p>Karun</p>
                                <span>Marketing / Photographer</span>
                            </div>
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/tinified/Ravi.jpg" src="app/assets/img/team/tinified/Ravi.jpg" alt="Ravi Photo">
                            </div>
                        ...
                        <div class="team-col">
                            ...
                            <div class="team-image">
                                <img class="lazyload" data-src="app/assets/img/team/tinified/Vignesh.jpg" src="app/assets/img/team/tinified/Vignesh.jpg" alt="Vignesh Photo">
                            </div>
