...
<head>
    ...
    <title> Videography - EliteSnaps </title>
...
<body id="body" class="body gradient-background">
    ...
    <div id="lowerlay-left" class="line__context line__context--center">
        <p class="text__left text__left--left text__left--left--video">EliteSnaps</p>
        <div class="line line__left"></div>
        <p class="text__left text__left--right text__left--right--video">Videography</p>
    </div>
    ...
    <main class="main" id="app">
        ...
        <section id="content" class="content anchor-animate--fadein">
            <div class="content__wrapper">
                ...
                <header>
                    <p class="title-desc">We cover all cinematography events, here is some of our work below.</p>
                </header>


                <div class="youtubeVideo__container">
                    <iframe class="youtubeVideo lazyload" data-src="//www.youtube.com/embed/rS7S0304Mqk?autoplay=1&amp;controls=0&amp;start=24" src="https://www.youtube.com/embed/rS7S0304Mqk?autoplay=1&amp;controls=0&amp;start=24" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>

                <div class="youtubeVideo__container">
                    <iframe class="youtubeVideo lazyload" data-src="//www.youtube.com/embed/u5H_2YKyiuA?controls=0" src="https://www.youtube.com/embed/u5H_2YKyiuA?controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>

                <div class="youtubeVideo__container">
                    <iframe class="youtubeVideo lazyload" data-src="//www.youtube.com/embed/YRfPJGwelyE?controls=0" src="https://www.youtube.com/embed/YRfPJGwelyE?controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>

                <div class="youtubeVideo__container">
                    <iframe class="youtubeVideo lazyload" data-src="//www.youtube.com/embed/DuOvK6VqUQw?controls=0" src="https://www.youtube.com/embed/DuOvK6VqUQw?controls=0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
